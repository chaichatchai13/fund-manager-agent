"""
Claude agent tool definitions and async handlers.
Tools are called by the agent loop in agent.py.
"""
import json
...
async def handle_tool_call(tool_name: str, tool_input: dict[str, Any]) -> Any:
    ...
    try:
        ...
        logger.error("Tool handler error", tool=tool_name, error=str(exc))
